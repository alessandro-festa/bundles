...
This tutorial uses Chroma DB.
    ...
    ![File loader chat flow](https://github.com/langflow-ai/langflow/blob/main/docs/static/img/tutorial-chatbot-embed-files.png)
    ...
    ![Chat with RAG flow](https://github.com/langflow-ai/langflow/blob/main/docs/static/img/tutorial-chatbot-chat-flow.png)
